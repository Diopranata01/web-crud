        ...
        <div class="col-md-6 contents">
          <div class="row justify-content-center">
            <div class="col-md-8">
              ...
              <h3>Log In | <a href="index_sign.php">Sign In</a></h3>
              
              <p class="mb-4">Selamat Datang !<br>Silahkan isi atau Daftar Sekarang (Sign Up)!</p>
            </div>
            <!--Koneksi ke auth-->
            <form action="auth/auth_log.php" method="post">
              ...
              <?php
                ...
                else if($_GET["error"]=="slhuser/nisn"){
              ?>
                  <div class="alert alert-danger" role="alert" style="text-align:center">
                  <?php echo "Username atau NISN salah";?>
                  </div>
              <?php
                }
                else if($_GET["error"]=="salahpass"){
              ?>
                  <div class="alert alert-danger" role="alert" style="text-align:center">
                  <?php echo "Password salah";?>
                  </div>
              <?php
                }
                  ...
                  ?>
                      <div class="alert alert-danger" role="alert" style="text-align:center">
                      <?php echo "Sesi anda telah berakhir";?>
                      </div>
                  <?php
                    }
                header ("refresh:5;url=index_log.php");
              }
              ?>
